...
namespace PizzaSiparisProgramı
{
    public partial class Form1 : Form
    {
        ...
        {
            string hazirConString = "Data Source=hazırPizza.db;Version=3";
            string kisiselConString = "Data Source=kisiselPizza.db;Version=3";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (radioButton1.Checked) // Hazır Pizza seçildiyse
            {
                ...
                string patates = comboBox11.SelectedItem.ToString();
                string icecek = comboBox12.SelectedItem.ToString();
                string sos = comboBox13.SelectedItem.ToString();
                string conString = "Data Source=hazırPizza.db;Version=3";
            ...
            else if (radioButton2.Checked) // Kişisel Pizza seçildiyse
            {
                ...
                string conString = "Data Source=kisiselPizza.db;Version=3";
                connection = new SQLiteConnection(conString);
                connection.Open();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                conString = "Data Source=hazırPizza.db;Version=3";
            }
            else if (radioButton2.Checked)
            {
                conString = "Data Source=kisiselPizza.db;Version=3";
            }
            else
            {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                if (radioButton1.Checked) // Hazır Pizza
                {
                    ...
                    comboBox11.SelectedItem = patates;
                    comboBox12.SelectedItem = icecek;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                using (SQLiteConnection connection = new SQLiteConnection(conString))
                {
                    ...
                    string query = "UPDATE hazır SET PizzaAdı = @PizzaAdı, Boyut = @Boyut, Patates = @Patates, Icecek = @Icecek, Sos = @Sos WHERE AdSoyad = @AdSoyad";
